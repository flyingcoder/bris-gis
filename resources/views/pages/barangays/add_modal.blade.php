                        ...
                        <div class='form-group row'>
                            <label class='col-md-4 control-label'>Province</label>
                                 <div class='col-md-6'>
                                        ...
                                        <input type='text' class='form-control' id='province-name' value='{{$municipality->province->name}}' disabled>                        
                                </div>
                        </div>
                        <div class='form-group row'>
                            <label class='col-md-4 control-label'>Municipality</label>
                                 <div class='col-md-6'>
                                        <input type='hidden' name='municipality_id' id='municipality-id' value='{{$municipality->id}}'>
                                        <input type='text' class='form-control' id='municipality-name' value='{{$municipality->name}}' disabled>   
                                 </div>
                         </div>
